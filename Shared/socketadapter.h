...
public:
    explicit SocketAdapter(boost::asio::io_context& io_context): _socket(io_context), _write_in_progress(false), _internal_buff(1024), _packet_data(1024), _temp_data(1024)
    {}
